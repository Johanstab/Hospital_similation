...
elektiv = pd.read_excel('/Users/sabinal/Desktop/MASTER 2022/DATA/Python kode/test4.xls') # Dette er en fil jeg lagde i R studio. fordi det å jobbe med tupels var helt jævlig <3 Dette kan kanskje bli en funksjon
...
if __name__ == '__main__':
    ...
    for m in range(1, 13): #Her går vi gjennom de 12 måneddedne
        ...
        for j in range(7): #Her går vi gjennom 7 ukedager, men fordi jeg er dum er index her 0 til 6, å jeg gidder ikke fikse på den <3
            ...
            dag.sort(key=lambda x: (x.hast_nummer, x.ventetid), reverse=True) #Her er mitt tapre forsøk på å sorte slik at man både tar hensyn til farge å ventetid. Ikke at det har hjulpet, men hei jeg prøvde
            ...
            for k in [dag, tidligkveld, kveld, natt]: # Her velger vi så kalrt hvilket skift i jobber med
                ...
                if skift == 1:
                    ...
                    tid_o = max(liste_stuer_o) # Dette er litt komp å forstå, men hør her. Vi finner den stuen som har mest tid(dette blir oppdaert lengre nede). Grunnen til det er fordi det er jo flere stuer som er oprative samtdig, så dette er måten vi tar hensyn til det på.
                    ...
                    liste_stuer_o.sort(reverse=True) #Denne biten er gøy. Siden vi har et redusert antall med stuer, så vil vi jo bruke de stuene som har mest tid igjen. Nå når jeg skriver denne kommentaren innser jeg at det ikke har en dritt å si, fordi stuetiden blir jo satt på ny ved nytt skift <3 nå hater jeg livet hahah
