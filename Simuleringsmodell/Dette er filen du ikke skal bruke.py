...
if __name__ == '__main__':
    ...
    for m in range(1, 13):  # Her går vi gjennom de 12 måneddedne
        ...
        for t in range(1,5):  # Her går vi gjennom 7 ukedager, men fordi jeg er dum er index her 0 til 6, å jeg gidder ikke fikse på den <3
                        ...
                        if i.fagOmrade == 'Ortopedi' and i.hast == 'Red':
                            if liste_stuer_o[0].get_time(skift) - i.stuetid - 45 >= 0:
                                ...
                                if i.tid == 4 and i.ukedag < 6:
                                    ...
                                    i.ukedag = 0
                                    i.tid = 1
                                if i.tid == 4 and i.ukedag == 6 and t == 4:
                                    i.ukedag = 0
                                    i.tid = 1
                                    i.month += 1
                                if i.month == 13:
