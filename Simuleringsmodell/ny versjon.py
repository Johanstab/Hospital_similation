...
elektiv = pd.read_excel(
    '/Users/sabinal/Desktop/untitled folder 2/Elektiv tid brukt.xls') # Dette er en fil jeg lagde i R studio. fordi det å jobbe med tupels var helt jævlig <3 Dette kan kanskje bli en funksjon
...
if __name__ == '__main__':
    ...
    for month in range(1, 13):  # Her går vi gjennom de 12 måneddedne

        counter_for_stueliste = 0

        for week in range(1,5):  # Her går vi gjennom 7 ukedager, men fordi jeg er dum er index her 0 til 6, å jeg gidder ikke fikse på den <3
            ...
            for weekday in range(7):
                ...
                for skift in range(1,5):

                    for index, row in elektiv.iterrows():
                        if row['Måned'] == month and row['Ukedag'] == weekday and row[
                    ...
                    if skift == 1 and counter_for_stueliste <= 1:
                    ...
                    elif skift == 2 and counter_for_stueliste <= 1:
                        liste_stuer_o = [stue_ort_1, stue_ort_2, stue_ort_3, stue_ort_4]
                        liste_stuer_a = [stue_andre_1, stue_andre_2, stue_andre_3, stue_andre_4,
                                         stue_andre_5]
                    ...
                    elif skift == 3 and counter_for_stueliste <= 1:
                        liste_stuer_o = [stue_ort_1, stue_ort_2, stue_ort_3, stue_ort_4]
                        liste_stuer_a = [stue_andre_1, stue_andre_2, stue_andre_3, stue_andre_4,
                                         stue_andre_5]
                    ...
                    elif skift == 4 and counter_for_stueliste <= 1:
                        liste_stuer_o = [stue_ort_1, stue_ort_2, stue_ort_3, stue_ort_4]
                        liste_stuer_a = [stue_andre_1, stue_andre_2, stue_andre_3, stue_andre_4,
                                         stue_andre_5]
                    ...
                    elif skift == 1 and counter_for_stueliste > 1:
                    ...
                    for i in pasient_liste:
                        if i.month == month and i.ukedag == weekday and i.tid == skift:
                            if i.fagOmrade == 'Ortopedi' and i.hast == 'Red':
                                if liste_stuer_o[0].get_time(skift) - i.stuetid - 45 >= 0:
                                    ...
                                    if i.tid == 4 and i.ukedag < 6:
                                        ...
                                        i.ukedag = 0
                                        i.tid = 1
                                    if i.tid == 4 and i.ukedag == 6 and week == 4:
                                        i.ukedag = 0
                                        i.tid = 1
                                        i.month += 1
                                    if i.month == 13:
                                ...
                                if i.tid == 4 and i.ukedag < 6:
                                    ...
                                    i.ukedag = 0
                                    i.tid = 1
                                elif i.tid == 4 and i.ukedag == 6 and week == 4:
                                    i.ukedag = 0
                                    i.tid = 1
                                    i.month += 1
                                if i.month == 13:
